...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-[30px] xl:bg-white dark:md:bg-secondary bg-muted p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
